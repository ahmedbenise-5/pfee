						...
						<div class="share-links">
							<div class="addthis_sharing_toolbox">
								...
								<ul>
									...
									<li>
									<a class="whatsapp" target="_bank"
										href="https://web.whatsapp.com://send?text=<?php echo rawurlencode(html_entity_decode(get_the_title(), ENT_COMPAT, 'UTF-8')); ?>" data-action="share/whatsapp/share">
