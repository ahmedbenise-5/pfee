                              ...
                              <!--begin::Table head-->
                                <thead>
                                    <tr class="fw-bolder text-muted">
                                        ...
                                        <th class="min-w-150px">Genders</th>
                                        <th class="min-w-150px">Specialisation</th>
                                        <th class="min-w-150px">Date join</th>
                                ...
                                <!--begin::Table body-->
                                <tbody>
                                    @if (isset($list_enseignants))
                                        @foreach ($list_enseignants as $list_enseignant)
                                            <tr>
                                                <td>
                                                    <div
                                                        class="form-check form-check-sm form-check-custom form-check-solid">
                                                ...
                                                <td>
                                                    <a href="#"
                                                        ...
                                                        @endif
                                                        {{-- {{ $list_enseignant->created_at->format('d-m-Y') ? $list_enseignant->created_at->format('d-m-Y') : ' aucun Description ' }} --}}
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content flex-shrink-0">
                                                        <a href="#" data-bs-toggle="modal"
                                                            data-bs-target="#update{{ $list_enseignant->id }}"
                                                        ...
                                                        <a data-bs-toggle="modal"
                                                            data-bs-target="#delete{{ $list_enseignant->id }}"
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <div class="d-flex flex-column mb-8 fv-row">
                                                        ...
                                                        <!--end::Label-->
                                                        <input class="form-control" type="date" name="Date_join">
