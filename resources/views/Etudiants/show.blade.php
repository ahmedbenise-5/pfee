                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-header">
                                                ...
                                                <div class="card-toolbar">
                                                    ...
                                                    <a href="#" class="btn btn-sm btn-primary my-1">Download
                                                        Report</a>
                                                </div>
                                                <!--end::Toolbar-->
                                            </div>
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody class="fw-6 fw-bold text-gray-600">
                                                            ...
                                                            <tr>
                                                                <td class="ps-9">
                                                                    <span
                                                                        class="badge badge-light-danger fs-7 fw-bolder">Unknown</span>
                                                                </td>
                                                                <td class="ps-0">
                                                                    <a href=""
                                                                        class="text-hover-primary text-gray-600">ReXe:
                                                                        Workstation 29</a>
                                                                </td>
                                                                <td>236.125.56.78</td>
                                                                <td>3 mins ago</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="ps-0">
                                                                    <a href=""
                                                                        class="text-hover-primary text-gray-600">RamenLC:
                                                                        Workstation 2</a>
                                                                </td>
                                                                <td>654.125.56.34</td>
                                                                <td>5 mins ago</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="ps-0">
                                                                    <a href=""
                                                                        class="text-hover-primary text-gray-600">Nest Five:
                                                                        Workstation 86</a>
                                                                </td>
                                                                <td>423.125.56.54</td>
                                                                <td>1 mins ago</td>
                                                            ...
                                                            <tr>
                                                                <td class="ps-9">
                                                                    <span
                                                                        class="badge badge-light-warning fs-7 fw-bolder">To
                                                                        be Paid</span>
                                                                </td>
                                                                <td class="ps-0">
                                                                    <a href=""
                                                                        class="text-hover-primary text-gray-600">Swedline:
                                                                        Workstation 54</a>
                                                                </td>
                                                                <td>441.967.56.54</td>
                                                                <td>8 mins ago</td>
