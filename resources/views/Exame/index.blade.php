                            ...
                            @can('ajouter_sections')
                                <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <a href="#" class="btn  btn-primary" data-bs-toggle="modal"
                                        ...
                                        <!--end::Svg Icon-->Ajouter une Exame
                                    </a>
                            ...
                            <table id="kt_datatable_example_5"
                                ...
                                <thead>
                                    <tr class="fw-bolder text-muted">
                                        ...
                                        <th class="min-w-150px">Nom Exame </th>
                                        <th class="min-w-150px">Enseignants </th>
                                        <th class="min-w-150px">niveaux de Etude</th>
                                            ...
                                            <tr>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#"
                                                                ...
                                                                {{ $exame->name ? $exame->name : ' aucun section  ' }}
                                                            </a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        {{ $exame->Classes->Nom_Classe ? $exame->Classes->Nom_Classe : ' aucun Description ' }}
                                                    </a>
                                                </td>
                                                <td>
                                                    ...
                                                    <a href="#"
                                                        class="text-dark fw-bolder text-hover-primary d-block fs-6">
                                                        {{ $exame->Enseignants->Nom ? $exame->Enseignants->Nom : ' aucun Description ' }}
                                                    </a>
                                                </td>
                                                <td>
                                                    ...
                                                    <a href="#"
                                                        class="text-dark fw-bolder text-hover-primary d-block fs-6">
                                                        {{ $exame->Sections->nom_section ? $exame->Sections->nom_section : ' aucun Description ' }}
                                                    </a>
                                                </td>
                                                <td>
                                                ...
                                                <div class="modal-dialog mw-650px">
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <form action="{{ route('sections.update', 'upadte') }}"
                                                                ...
                                                                <div class="d-flex flex-column mb-8 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <input type="text" name='nom_section'
                                                                        value="{{ $list_section->nom_section }}"
                                                                        class="form-control form-control-solid"
                                                                        placeholder="Enter Nom du section"
                                                                        name="nom_section" />
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="d-flex flex-column mb-8">
                                                                    ...
                                                                    <select class="form-select " name="Niveauxdetudes_id"
                                                                        ...
                                                                        <option value="{{ $list_niveauetudes->id }}"
                                                                            selected>{{ $list_niveauetudes->Nom }}</option>
                                                                        {{-- @endforeach --}}
                                                                    </select>
                                                                </div>
                                                                <!--end::Input group-->
                                                                ...
                                                                <div class="d-flex flex-column mb-8">
                                                                    ...
                                                                    <select class="form-select " id="multiple-checkboxes"
                                                                        multiple="multiple" name="enseignant_id[]">
                                                                ...
                                                                <div class="mb-10">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <input class="form-check-input" type="checkbox"
                                                                            @if ($list_section->statut === 1) checked="checked"
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <button type="submit"
                                                                        class="btn btn-primary">Modiefer</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
    ...
    <script>
                $(document).ready(function () {
                    $('select[name="Niveauxdetudes_id"]').on('change', function () {
                        ...
                        if (Niveauxdetudes_id) {
                            $.ajax({
                                url: "{{ URL::to('getclasses') }}/" +Niveauxdetudes_id,
                                type: "GET",
                                dataType: "json",
