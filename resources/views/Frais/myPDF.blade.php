...
<body>
    <div class="page">
        ...
        <h2 class="title_pdf">
            Reçu de facture d'Etudiant
        </h2>
        <br>
        <h4 class="title">Nom complet : <code class="cd"
                style="color:
            #7a7b7e">{{ $facture->etudaint->name }} </code></h4>
        <h4 class="title">Niveaux de Etudes : <code class="cd"
                style="color:
        #7a7b7e">{{ $facture->niveauxdetudes->Nom}} </code></h4>
        <h4 class="title">classes :
            <code  class="cd" style="color: 
        #7a7b7e">{{ $facture->Classes->Nom_Classe}}  </code></h4>
        <h4 class="title">Montante :
            <code  class="cd" style="color:
        #7a7b7e">{{ $facture->montante}} MAD </code></h4>
        <h4 class="title">Date Facture :
            <code class="cd" style="color:
        #7a7b7e">{{ $facture->date_facture}}  </code></h4>
        <h4 class="title">Description :
            <code class="cd" style="color:
        #7a7b7e">{{ $facture->description ?  ''  : 'Pas de description'}} </code></h4><br>
