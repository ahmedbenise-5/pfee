...
<body>
    <div class="page">
        ...
        <h2 class="title_pdf">
            Reçu de Faris Taritement d'Etudiant
        </h2>
        <br>
        ...
        <h4 class="title">Montante :
            <code  class="cd" style="color:
        #7a7b7e">{{ $FraisTraitement->Debit}} MAD </code></h4>
        <h4 class="title">Date Facture :
            <code class="cd" style="color:
        #7a7b7e">{{ $FraisTraitement->date}}  </code></h4>
        <h4 class="title">Description :
            <code class="cd" style="color:
        #7a7b7e">{{ $FraisTraitement->description}} </code></h4><br>
