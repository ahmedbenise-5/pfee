                            ...
                            @can('ajouter_sections')
                                <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <a href="#" class="btn  btn-primary" data-bs-toggle="modal"
                                        ...
                                        <!--end::Svg Icon-->Ajouter une Matier
                                    </a>
                            ...
                            <table id="kt_datatable_example_5"
                                ...
                                <thead>
                                    <tr class="fw-bolder text-muted">
                                        ...
                                        <th class="min-w-150px">Nom de Matier</th>
                                        <th class="min-w-150px">Niveauxdetudes </th>
                                ...
                                <tbody>
                                    @if (isset($matieres))
                                        @foreach ($matieres as $matiere)
                                            <tr>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="d-flex justify-content-start flex-column">
                                                            <a href="#"
                                                                ...
                                                                {{ $matiere->name ? $matiere->name : ' aucun section  ' }}
                                                            </a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        {{ $matiere->niveauxdetudes->Nom ? $matiere->niveauxdetudes->Nom : ' aucun Description ' }}
                                                    </a>
                                                </td>
                                                <td>
                                                    ...
                                                    <a href="#"
                                                        class="text-dark fw-bolder text-hover-primary d-block fs-6">
                                                        {{ $matiere->Classes->Nom_Classe ? $matiere->Classes->Nom_Classe : ' aucun Description ' }}
                                                    </a>
                                                </td>
                                                <td>
                                                    <div class="d-flex justify-content flex-shrink-0">

                                                        {{-- @can('modifier_sections') --}}
                                                        <a href="#" data-bs-toggle="modal"
                                                            data-bs-target="#update{{ $matiere->id }}"
                                                        ...
                                                        {{-- @endcan --}}
                                                        {{-- @can('supprimer_sections') --}}
                                                        <a data-bs-toggle="modal"
                                                            data-bs-target="#delete{{ $matiere->id }}"
                                            ...
                                            <!-- Modal -->
                                            <!-- Modal -->
                                            <div class="modal fade" tabindex="-1" id="update{{ $matiere->id }}">
                                                <div class="modal-dialog mw-650px">
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <form action="{{ route('Matieres.update', $matiere->id) }}"
                                                                method="POST" id="kt_modal_new_target_form"
                                                                class="form">
                                                                @csrf
                                                                @method('patch')
                                                                x <div class="mb-11 text-center">
                                                                    <!--begin::Title-->
                                                                    <h1 class="text-muted fw-bold ">Modifier une matiere
                                                                    </h1>
                                                                    <!--end::Title-->
                                                                ...
                                                                <div class="d-flex flex-column mb-8 fv-row">
                                                                    ...
                                                                    <label
                                                                        ...
                                                                        <span class="required">Nom de matiere</span>
                                                        ...
                                                        title="Specify a target name for future usage and reference"></i> --}}
                                                                    ...
                                                                    <input type="text" name='name'
                                                                        ...
                                                                        placeholder="Enter Nom de matiere" name="name"
                                                                        value="{{ $matiere->name }}" />
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="d-flex flex-column mb-8">
                                                                    ...
                                                                    <select class="form-select " name="id_niveauxdetudes"
                                                                        ...
                                                                        <option value="" selected disabled> choiser
                                                                        </option>
                                                                        @foreach ($niveauxdetudes as $niveauxdetude)
                                                                            <option value="{{ $niveauxdetude->id }}"
                                                                                {{ $niveauxdetude->id == $matiere->id_niveauxdetudes ? 'selected' : '' }}>
                                                                                {{ $niveauxdetude->Nom }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                <!--end::Input group-->
                                                                ...
                                                                <div class="d-flex flex-column mb-8">
                                                                    ...
                                                                    <select class="form-select " name="id_classes">
                                                                        @foreach ($classes as $classe)
                                                                            <option value="{{ $classe->id }}"
                                                                                {{ $classe->id == $matiere->id_classes ? 'selected' : '' }}>
                                                                                {{ $classe->Nom_Classe }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                                                    ...
                                                                    <div class="d-flex flex-column mb-8">
                                                                        ...
                                                                        <select class="form-select "
                                                                            ...
                                                                            @foreach ($enseignants as $enseignant)
                                                                                <option
                                                                                    value="{{ $enseignant->Nom_enseignants }}"
                                                                                    {{ $enseignant->Nom_enseignants == $matiere->enseignants ? 'selected' : '' }}>
                                                                                    {{ $enseignant->Nom_enseignants }}
                                                                                </option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                            ...
                                            <!-- modul delte -->
                                            <div class="modal fade" tabindex="-1" id="delete{{ $matiere->id }}">
                                                <div class="modal-dialog mw-650px">
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <form
                                                                action="{{ URL::route('Matieres.destroy', $matiere->id) }}"
                                                                method="POST" id="kt_modal_new_target_form"
                                                                class="form">
                                                                @method('delete')
                                                                @csrf
                                                                ...
                                                                <div class="mb-13 text-center">
                                                                    <!--begin::Title-->
                                                                    <h1 class="mb-3">Supperimer un matiere</h1>
                                                                ...
                                                                <div class="d-flex flex-column mb-8 fv-row">
                                                                    ...
                                                                    <label
                                                                        ...
                                                                        <span class="required">voulez-vous
                                                                            supprimer matiere </span>
                                                                        <code>{{ $matiere->name }}</code>
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('Matieres.store') }}" method="POST"
                                            ...
                                            <div class="mb-11 text-center">
                                                <!--begin::Title-->
                                                <h1 class="text-muted fw-bold ">Ajouter une matiere</h1>
                                                <!--end::Title-->
                                                <div class="separator border-2 my-10"></div>
                                            </div>
                                            <!--end::Heading-->
                                            ...
                                            <div class="d-flex flex-column mb-8">
                                                ...
                                                <select class="form-select " name="id_niveauxdetudes"
                                                    onchange="console.log($(this).val())">
                                                    <option value="" selected disabled> choiser</option>
                                                    @foreach ($niveauxdetudes as $niveauxdetude)
                                                        <option value="{{ $niveauxdetude->id }}">
                                                            {{ $niveauxdetude->Nom }}</option>
                                                    @endforeach
                                            ...
                                            @if (isset($enseignants))
                                                <div class="d-flex flex-column mb-8">
                                                    ...
                                                    <select class="form-select " name="id_enseignants">
                                                        @foreach ($enseignants as $enseignant)
                                                            <option value="{{ $enseignant->Nom_enseignants }}">
