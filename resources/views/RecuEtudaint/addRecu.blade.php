        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Facture de Paiement 
                        <!--begin::Separator-->
                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12 pe-lg-10">
                                <!--begin::Form-->
                                <form action="{{route('RecuEtudaint.store')}}"
                                method="POST"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <div class="col-md fv-row">
                                                ...
                                                <input type="number" class="form-control form-control" placeholder="" name="montante">
                                            </div>
                                    </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-6 fv-row fv-plugins-icon-container">
                                            ...
                                            <!--end::Label-->
                                            <!--end::Input-->
                                            <input type="text" class="form-control form-control" placeholder="" name="description">
                                            <!--end::Input-->
