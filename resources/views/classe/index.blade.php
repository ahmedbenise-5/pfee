									...
									<div class="me-4">
										...
										<button type="button" class="btn btn-light-primary me-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_621214a8b8f66">
                                                ...
                                                <!--end::Menu separator-->
                                                <!--begin::Form-->
                                                <form  action="{{URL::route('classe.index')}}"  method="get">
                                                @csrf
                                                <div class="px-7 py-5">
                                                    <!--begin::Input group-->
                                                    <div class="mb-10">
                                                        ...
                                                        <!--end::Label-->
                                                            <!--begin::Input-->
                                                <div>
                                                    <select class="form-select form-select-solid" data-control="select2"  name="niveauxetude" data-placeholder="Select an option" data-allow-clear="true">
