                        ...
                        <!--begin::Table head-->
                          <thead>
                              <tr class="fw-bolder text-muted">
                                  ...
                                  <th class="min-w-150px">Nom complet</th>
                                  <th class="min-w-150px">Email </th>
                                  <th class="min-w-150px">Numéro identifiant</th>
                                      ...
                                      <tr>
                                              ...
                                              <div class="d-flex align-items-center">
                                                  <div
                                                      ...
                                                      <a href="#"
                                                          ...
                                                          {{ $parente->NomPraent ? $parente->NomPraent : ' aucun section  ' }}
                                                      </a>
                                                  </div>
                                              </div>
                                          </td>
                                          <td>
                                              ...
                                              <a href="#"
                                                  ...
                                                  {{ $parente->Email ? $parente->Email : ' aucun Description ' }}
                                              </a>
                                          </td>
                                          <td>
                                              ...
                                              <a href="#"
                                                  class="text-dark fw-bolder text-hover-primary d-block fs-6">
                                                  {{ $parente->NumeroIdentifiant ? $parente->NumeroIdentifiant : ' aucun Description ' }}
                                              </a>
                                          </td>
                                          <td>
                                            <div class="d-flex justify-content flex-shrink-0">
                                                <a href="{{url('edit_parentes')}}/{{$parente->id}}"
                                                ...
                                                <a data-bs-toggle="modal"
                                                    data-bs-target="#delete{{$parente->id}}" href="#"
                                          ...
                                          <!-- modul delte -->
                                          <div class="modal fade" tabindex="-1" id="delete{{ $parente->id }}">
                                            <div class="modal-dialog mw-650px">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <form action="{{ URL::route('parentes.destroy', 'delete') }}"
                                                            ...
                                                            <div class="d-flex flex-column mb-8 fv-row">
                                                                ...
                                                                <label
                                                                    ...
                                                                    <span class="required">voulez-vous
                                                                        supprimer Praente </span>
                                                                    <code>{{ $parente->NomPraent }}</code>
