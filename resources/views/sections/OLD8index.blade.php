                                           ...
                                           <td>
                                               <div class="d-flex justify-content flex-shrink-0">
                                                   <a href="#" data-bs-toggle="modal"
                                                       data-bs-target="#update{{ $niveauxdetude->id }}"
                                                   ...
                                                   <a data-bs-toggle="modal"
                                                       data-bs-target="#delete{{ $niveauxdetude->id }}"
                                        ...
                                        <form action="{{ route('sections.store') }}" method="POST"
                                            ...
                                            <div class="d-flex flex-column mb-8">
                                                ...
                                                <select class="form-select " name="Niveauxdetudes_id"  onchange="console.log($(this).val())">
                                                    ...
                                                    <option value="{{$list_niveauetude->id}}"
                                                        @if (old('Niveauxdetudes_id') == $list_niveauetude->id)
                                                        selected
                                                         @endif
                                                        >{{$list_niveauetude->Nom}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <!--end::Input group-->
