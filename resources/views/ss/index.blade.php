                                                ...
                                                <tr>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="d-flex justify-content-start flex-column">
                                                                <a href="#"
                                                                    ...
                                                                    {{ $classe->Nom ? $classe->Nom : '<small> aucun Classe </small>' }}
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            {{ $classe->Description ? $classe->Description : '<small> aucun Description </small>' }}
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="#"
                                                            class="text-dark fw-bolder text-hover-primary d-block fs-6">
                                                            {{ $classe->created_at->format('d-m-Y')? $classe->created_at->format('d-m-Y'): '<small> aucun Description </small>' }}
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex justify-content flex-shrink-0">
                                                            <a href="#" data-bs-toggle="modal" data-bs-target="#update{{$classe->id}}"
                                                            ...
                                                            <a data-bs-toggle="modal" data-bs-target="#delete{{$classe->id}}" 
                                                                ...
                                                                <form action="{{URL::route('niveauxdetudes.update','update')}}" method="POST"
                                                                    ...
                                                                    <div class="d-flex flex-column mb-8">
                                                                        ...
                                                                        <textarea class="form-control form-control-solid"
                                                                            ...
                                                                            placeholder="Type Target Details">{{$classe->Description}}</textarea>
                                                                    </div>
                                                                    <!--end::Input group-->
